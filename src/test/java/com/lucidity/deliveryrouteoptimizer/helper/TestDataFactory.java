...
public final class TestDataFactory {
    ...
    public static DeliveryRequestVo twoOrderScenario() {
        List<OrderVo> orders = List.of(
                new OrderVo(1, INDIRANAGAR, HSR_LAYOUT, 15.0),
                new OrderVo(2, BTM_LAYOUT, JAYANAGAR, 25.0)
        );
        return new DeliveryRequestVo(KORAMANGALA, orders);
    }
    ...
    public static DeliveryRequestVo singleOrderScenario() {
        OrderVo order = new OrderVo(1, INDIRANAGAR, HSR_LAYOUT, 10.0);
        return new DeliveryRequestVo(KORAMANGALA, List.of(order));
    }
    ...
    public static DeliveryRequestVo threeOrderScenario() {
        List<OrderVo> orders = List.of(
                new OrderVo(1, INDIRANAGAR, HSR_LAYOUT, 15.0),
                new OrderVo(2, BTM_LAYOUT, JAYANAGAR, 20.0),
                new OrderVo(3, MG_ROAD, ELECTRONIC_CITY, 10.0)
        );
        return new DeliveryRequestVo(KORAMANGALA, orders);
    }
    ...
    public static DeliveryRequestVo largeOrderScenario(int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            orders.add(new OrderVo(i + 1, restaurant, consumer, prepTime));
        }
    ...
    public static DeliveryRequestVo longPrepTimeScenario() {
        List<OrderVo> orders = List.of(
                new OrderVo(1, INDIRANAGAR, HSR_LAYOUT, 60.0),
                new OrderVo(2, BTM_LAYOUT, JAYANAGAR, 5.0)
        );
        return new DeliveryRequestVo(KORAMANGALA, orders);
    }
}
